...
def hist2d(x, y, n=100):
    # 2d histogram used in old_labels.png and evolve.png
...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=1920, max_subplots=16):
    # Plot image grid with old_labels
    ...
    for i in range(i + 1):
        ...
        if len(targets) > 0:
            ...
            labels = ti.shape[1] == 6  # old_labels if no conf column
...
def plot_labels(labels, names=(), save_dir=Path('')):
    # plot dataset old_labels
    LOGGER.info(f"Plotting old_labels to {save_dir / 'old_labels.jpg'}... ")
    ...
    plt.savefig(save_dir / 'old_labels.jpg', dpi=200)
    matplotlib.use('Agg')
    plt.close()
